...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room_code', models.CharField(default=uuid.uuid4, max_length=10, unique=True)),
                ('status', models.CharField(default='waiting', max_length=20)),
                ('mode', models.CharField(default='stock', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.asset')),
